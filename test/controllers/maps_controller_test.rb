...
class MapsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create map" do
    assert_difference('Map.count') do
      post maps_url, params: { map: { ceus_id: @map.ceus_id, clients_id: @map.clients_id, usstates_id: @map.usstates_id } }
    end
  ...
  test "should update map" do
    patch map_url(@map), params: { map: { ceus_id: @map.ceus_id, clients_id: @map.clients_id, usstates_id: @map.usstates_id } }
